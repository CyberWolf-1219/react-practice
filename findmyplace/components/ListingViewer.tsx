...
function ListingViewer({ userID }: { userID: string }) {
  ...
  if (listings.length > 0) {
    return (
      <div className="mt-14 w-full h-[200px] p-1 overflow-x-scroll overflow-y-hidden flex flex-row gap-1 items-center justify-start bg-slate-200 shadow-md shadow-slate-500 md:mt-24">
    ...
    return (
      <div className="mt-14 w-full h-[200px] p-1 overflow-y-auto flex flex-col gap-1 items-center justify-center bg-slate-300 shadow-md shadow-slate-500 md:mt-24 ">
