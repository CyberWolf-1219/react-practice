  ...
  return (
    <section className="max-w-screen-lg w-full h-fit mx-auto flex flex-col gap-8 py-4 px-12">
      <div className="w-fill text-center">
        <h2 className="font-bold text-3xl text-gray-500">We Are Here From</h2>
      </div>

      <div className="w-full flex flex-col md:flex-row items-center justify-center gap-12 overflow-visible text-center">
        <div className="md:w-[200px] h-[180px] flex flex-col items-center justify-start gap-4">
          <span className="w-fit block">
            <svg
              className="w-[76px] h-[76px] fill-gray-500"
          ...
          <span className="w-3/4 inline-block">
            <h4 className="font-bold text-3xl text-gray-500">150+</h4>
            <a
              href="#"
              className="w-full flex items-center justify-center font-semibold text-base gap-4"
            >
